...
import "./SuperAdminClassesManagement.css";
...
function SuperAdminClassesManagement() {
  ...
  if (component == false) {
    ...
    return (
      <div className="base_bg w-100 p-4">
        <h1 className="my-1">
          <b>{tokenFirstname}'S CLASS STUDENTS MANAGEMENT PAGE</b>
        </h1>
            ...
            <div className="w-100 d-flex justify-content-between align-items-center my-3">
              <div className="w-100 d-flex">
                ...
                <div className="w-25 mx-2">
                  <div className="inputBox3 input-group">
                    <select
                    ...
                    >
                      ...
                      {professors.length > 0
                        ? professors
                            .sort((prof1, prof2) =>
                              prof1.user_lastname.localeCompare(
                                prof2.user_lastname
                              )
                            )
                            .map((prof) => (
                              <option
                                key={`${prof.id}-${prof.user_lastname}-${prof.user_firstname}`}
                                value={prof.prof_id}
                                title={`Professor ID: ${prof.prof_id}`}
                              >
                                {prof.user_lastname}, {prof.user_firstname}
                              </option>
                            ))
                        : ""}
                    </select>
                ...
                <div className="w-25">
                  <button
                    ...
                    onClick={() => handleProfessorClasses()}
                  >
                    <img
...
export default SuperAdminClassesManagement;
